#import "IntercomObjcPlugin.h"
#import <MIntercom/MIntercom.h>



id unread;

@implementation UnreadStreamHandler : NSObject
...
@implementation IntercomObjcPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    IntercomObjcPlugin* instance = [[IntercomObjcPlugin alloc] init];
